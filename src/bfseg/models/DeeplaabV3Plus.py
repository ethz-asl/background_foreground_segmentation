...
Code taken and adjusted from https://github.com/bonlime/keras-deeplab-v3-plus
...
def Deeplabv3(weights='pascal_voc',
  ...
  b4 = Lambda(lambda x: K.expand_dims(x, 1))(b4)
  b4 = Conv2D(256, (1, 1), padding='same', use_bias=False,
  ...
  if (weights == 'pascal_voc' and classes == 21) or (weights == 'cityscapes' and
                                                     classes == 19):
