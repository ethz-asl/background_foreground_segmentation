...
Code taken from https://github.com/bonlime/keras-deeplab-v3-plus
...
def Deeplabv3(weights='pascal_voc', input_tensor=None, input_shape=(512, 512, 3), classes=21, backbone='xception',
    ...
    print("removing top for multitasking")
    ...
    # decoded semseg
    semseg = Conv2D(classes, (1, 1), padding='same', name="semseg_decoder")(before_decoder_layer)
