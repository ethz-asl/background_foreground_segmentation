...
def train(experiment):
    ...
    experiment_name = experiment.__class__.__name__ + "{}_{}_{}_{}lr_{}bs_{}ep".format(args.name_prefix, args.backbone,
                                                                                       args.model_name,
                                                                                       args.optimizer_lr,
...
def runExperiment(config, experiment, metricCallback, outFolder):
    ...
    scoreAndPlotPredictions(lambda img: model.predict(img), test_ds, experiment.numTestImages, plot=False)
