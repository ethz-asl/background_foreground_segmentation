...
def test_weighted_ignorant_accuracy():
    ...
    weighted_ignorant_accuracy.update_state(labels_unbalanced, prediction_all_zeros)
    ...
    weighted_ignorant_accuracy.update_state(labels_unbalanced, prediction_all_twos)
